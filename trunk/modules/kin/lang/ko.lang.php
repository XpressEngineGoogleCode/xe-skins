<?php
    ...
    $lang->replies = '답변';
    $lang->msg_no_questions = '에 대한 질문이 없습니다.';
    $lang->msg_no_replies = '에 대한 답변이 없습니다.';
    $lang->msg_no_my_questions = '에 대한 내 질문이 없습니다.';
    $lang->msg_no_article = '글이 없습니다.';

    $lang->notify_message = '답변알림';
    $lang->about_notify_message = '답변이 추가되면 쪽지 또는 메일로 알려주는 기능입니다';

    $lang->ask_category = '질문분류';
    $lang->cmd_load_saved_document = '임시 저장된 글 불러오기';
